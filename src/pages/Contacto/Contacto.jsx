...
export const Contacto = () => {
  ...
  return (
    <div
      id="contacto"
      className="scroll-mt-36 min-h-screen  bg-gray-100 flex flex-col justify-center items-center p-6 relative overflow-hidden"
      data-aos="fade-left"
    >
      {/* Fondo decorativo */}
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 max-w-md mx-auto transform transition-all duration-300 hover:shadow-xl hover:scale-105 border border-gray-200 z-10">
        ...
        <p className="text-center mb-4 font-poppins text-xl md:text-lg text-gray-700">
          ¡Me encantaría saber de ti! Conéctate conmigo en las siguientes
          plataformas:
        </p>
        <div className="flex flex-col md:flex-row justify-center items-center space-x-0 md:space-x-4 mt-6">
          <a
            href="https://wa.me/3114220469"
            target="_blank"
      ...
      {/* Justificación para contactar */}
      <div className="mt-6 md:mt-10 text-center max-w-lg mx-auto z-10">
        <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mb-4 animate-fadeIn">
          ¿Por qué contactarme?
        </h2>
        <p className="text-gray-600 text-lg md:text-lg font-poppins mb-6 animate-fadeIn">
          Estoy aquí para colaborar en proyectos interesantes, responder
          preguntas o simplemente conectar. ¡No dudes en escribirme!
        </p>

        {/* Elementos decorativos */}
        <div className="absolute bottom-10 left-0 right-0 text-center">
          <div className="text-4xl md:text-6xl text-gray-500 opacity-20">
            ✨
          </div>
        </div>
      </div>
