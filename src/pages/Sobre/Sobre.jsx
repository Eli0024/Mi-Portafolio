...
export const Sobre = () => {
  ...
  return (
    <div 
      id="sobre" 
      data-aos="fade-down" 
      className="scroll-mt-36 min-h-screen bg-gray-800 flex items-center justify-center"
    >
      <div className="flex flex-col md:flex-row items-center justify-center space-x-0 md:space-x-6 transition-opacity duration-700 w-full px-4">
        ...
        <div className="bg-transparent rounded-2xl p-8 flex flex-col w-full md:w-2/3">
          ...
          <p className="text-xl md:text-2xl text-white mb-6 text-center font-poppins">{Data.introduccion.texto}</p>
          <p className="text-xl md:text-2xl text-white mb-6 text-center font-poppins">{Data.introduccion.habilidades}</p>
          <p className="text-xl md:text-2xl text-white mb-6 text-center font-poppins">{Data.disposicion.texto}</p>
        </div>
      </div>
    </div>
  );
