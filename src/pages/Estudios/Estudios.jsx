      ...
      <div className="w-full max-w-6xl">
        ...
        <Slider {...settings}>
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-4xl font-poppins font-semibold pb-4 text-center text-gray-100">EDUCACION</h3>
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-4xl font-semibold pb-4 text-center text-gray-100">EXPERIENCIA</h3>
            <div className="flex flex-col items-center space-y-4">
